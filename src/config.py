...
class Config:
    ...
    MAX_HISTORY_SIZE: int = int(os.getenv('MAX_HISTORY_SIZE', '43200'))
    ...
    PROMETHEUS_URL: str = os.getenv('PROMETHEUS_URL', 'http://prometheus-stack-kube-prom-prometheus.monitoring.svc.cluster.local:9090')